...
*** Variables ***
${URL}         					homolog.core.fleetdesk.com.br
${NAVEGADOR}        			Firefox
${TITULO_PAGINA}                Fleetdesk

${DELAY}          				1
${VALID_USER}     				homolog@fleetdesk.com.br
${VALID_PASSWORD}  				hml123
${LOGIN_URL}      				http://${SERVER}/login
${WELCOME_URL}    				http://${SERVER}/routing
${ERROR_URL}      				http://${SERVER}/login
${VEHICLES_URL}   				http://${SERVER}/vehicles

${BOTAO_VEHICLES}               ... xpath=.//*[@id="register"]
${BOTAO_CADASTRO}               i class="fa fa-plus-square-o"
...
...botão tela veiculos     	css=.item-menu:nth-child(3) path
...
